...
|--|--|
| **Event ID** | 4697 |
| **Event Message** | A service was installed in the system. |
...
| **Task ID** | 12289 |
| **Task Name** | SE_ADT_SYSTEM_SECURITYSUBSYSTEMEXTENSION |
| **Category** | System |
| **Category GUID** | {69979848-797A-11D9-BED3-505054503030} |
| **Internal Category ID** | 0 |
| **Sub-Category** | Security System Extension |
| **Sub-Category GUID** | {0CCE9211-69AE-11D9-BED3-505054503030} |
| **Internal Sub-Category ID** | 1 |
| **Event Type** | Success |
| **Logging Binary** | TBD |
