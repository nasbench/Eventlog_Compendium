...
|--|--|
| **Event ID** | 5156 |
| **Event Message** | The Windows Filtering Platform has allowed a connection. |
...
| **Task ID** | 12810 |
| **Task Name** | SE_ADT_OBJECTACCESS_FIREWALLCONNECTION |
| **Category** | Object Access |
| **Category GUID** | {6997984A-797A-11D9-BED3-505054503030} |
| **Internal Category ID** | 2 |
| **Sub-Category** | Filtering Platform Connection |
| **Sub-Category GUID** | {0CCE9226-69AE-11D9-BED3-505054503030} |
| **Internal Sub-Category ID** | 25 |
| **Event Type** | Success |
| **Logging Binary** | TBD |
