...
|--|--|
| **Event ID** | 4756 |
| **Event Message** | A member was added to a security-enabled universal group. |
...
| **Task ID** | 13826 |
| **Task Name** | SE_ADT_ACCOUNTMANAGEMENT_SECURITYGROUP |
| **Category** | Account Management |
| **Category GUID** | {6997984E-797A-11D9-BED3-505054503030} |
| **Internal Category ID** | 6 |
| **Sub-Category** | Security Group Management |
| **Sub-Category GUID** | {0CCE9237-69AE-11D9-BED3-505054503030} |
| **Internal Sub-Category ID** | 47 |
| **Event Type** | Success |
| **Logging Binary** | TBD |
