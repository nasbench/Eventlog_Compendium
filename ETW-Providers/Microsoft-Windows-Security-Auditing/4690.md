...
|--|--|
| **Event ID** | 4690 |
| **Event Message** | An attempt was made to duplicate a handle to an object. |
...
| **Task ID** | 12807 |
| **Task Name** | SE_ADT_OBJECTACCESS_HANDLE |
| **Category** | Object Access |
| **Category GUID** | {6997984A-797A-11D9-BED3-505054503030} |
| **Internal Category ID** | 2 |
| **Sub-Category** | Handle Manipulation |
| **Sub-Category GUID** | {0CCE9223-69AE-11D9-BED3-505054503030} |
| **Internal Sub-Category ID** | 23 |
| **Event Type** | Success |
| **Logging Binary** | TBD |
...
```powershell
auditpol.exe /set /subcategory:{0CCE9223-69AE-11D9-BED3-505054503030} /success:enable /failure:enable
```
