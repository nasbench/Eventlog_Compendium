...
|--|--|
| **Event ID** | 4776 |
| **Event Message** | The domain controller attempted to validate the credentials for an account. |
...
| **Task ID** | 14336 |
| **Task Name** | SE_ADT_ACCOUNTLOGON_CREDENTIALVALIDATION |
| **Category** | Account Logon |
| **Category GUID** | {69979850-797A-11D9-BED3-505054503030} |
| **Internal Category ID** | 8 |
| **Sub-Category** | Credential Validation |
| **Sub-Category GUID** | {0CCE923F-69AE-11D9-BED3-505054503030} |
| **Internal Sub-Category ID** | 55 |
