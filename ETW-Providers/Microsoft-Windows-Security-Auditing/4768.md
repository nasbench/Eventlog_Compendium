...
|--|--|
| **Event ID** | 4768 |
| **Event Message** | A Kerberos authentication ticket (TGT) was requested. |
...
| **Task ID** | 14339 |
| **Task Name** | SE_ADT_ACCOUNTLOGON_KERBCREDENTIALVALIDATION |
| **Category** | Account Logon |
| **Category GUID** | {69979850-797A-11D9-BED3-505054503030} |
| **Internal Category ID** | 8 |
| **Sub-Category** | Kerberos Authentication Service |
| **Sub-Category GUID** | {0CCE9242-69AE-11D9-BED3-505054503030} |
| **Internal Sub-Category ID** | TBD |
