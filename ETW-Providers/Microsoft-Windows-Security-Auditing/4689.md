...
|--|--|
| **Event ID** | 4689 |
| **Event Message** | A process has exited. |
...
| **Task ID** | 13313 |
| **Task Name** | SE_ADT_DETAILEDTRACKING_PROCESSTERMINATION |
| **Category** | Detailed Tracking |
| **Category GUID** | {6997984C-797A-11D9-BED3-505054503030} |
| **Internal Category ID** | 4 |
| **Sub-Category** | Process Termination |
| **Sub-Category GUID** | {0CCE922C-69AE-11D9-BED3-505054503030} |
| **Internal Sub-Category ID** | 34 |
| **Event Type** | Success |
| **Logging Binary** | TBD |
